...
namespace B2B_App
{
    ...
    public partial class WebsiteTemplateAdditionalInfo : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        private WebsiteTemplateAdditionalInfoDepartureTime _departureTime;
        
        private WebsiteTemplateAdditionalInfoArrivalTime _arrivalTime;
        ...
        public WebsiteTemplateAdditionalInfo()
        {
            ...
            this._arrivalTime = new WebsiteTemplateAdditionalInfoArrivalTime();
            this._departureTime = new WebsiteTemplateAdditionalInfoDepartureTime();
        ...
        public WebsiteTemplateAdditionalInfoDepartureTime DepartureTime
        {
            get
            {
        ...
        public WebsiteTemplateAdditionalInfoArrivalTime ArrivalTime
        {
            get
            {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true, Namespace="http://tempuri.org/WebsitesTemplate.xsd")]
    public partial class WebsiteTemplateAdditionalInfoDepartureTime : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public static async Task<WebsiteTemplateAdditionalInfoDepartureTime> LoadFromFile(string fileName, Windows.Storage.StorageFolder folder)
        {
            var _file = await folder.GetFileAsync(fileName);
            var xml = await Windows.Storage.FileIO.ReadTextAsync(_file);
            return Deserialize(xml);
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(WebsiteTemplateAdditionalInfoDepartureTime));
                }
                return serializer;
            }
        }
        ...
        #region Serialize/Deserialize
        /// <summary>
        /// Serializes current WebsiteTemplateAdditionalInfoDepartureTime object into an XML string
        /// </summary>
        /// <returns>string XML value</returns>
        public virtual string Serialize()
        {
        ...
        /// <summary>
        /// Deserializes workflow markup into an WebsiteTemplateAdditionalInfoDepartureTime object
        /// </summary>
        /// <param name="input">string workflow markup to deserialize</param>
        /// <param name="obj">Output WebsiteTemplateAdditionalInfoDepartureTime object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string input, out WebsiteTemplateAdditionalInfoDepartureTime obj, out System.Exception exception)
        {
            exception = null;
            obj = default(WebsiteTemplateAdditionalInfoDepartureTime);
            try
            {
                obj = Deserialize(input);
                return true;
        ...
        public static bool Deserialize(string input, out WebsiteTemplateAdditionalInfoDepartureTime obj)
        {
            System.Exception exception = null;
            return Deserialize(input, out obj, out exception);
        }
        
        public new static WebsiteTemplateAdditionalInfoDepartureTime Deserialize(string input)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(input);
                return ((WebsiteTemplateAdditionalInfoDepartureTime)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
                if ((stringReader != null))
        ...
        public static WebsiteTemplateAdditionalInfoDepartureTime Deserialize(System.IO.Stream s)
        {
            return ((WebsiteTemplateAdditionalInfoDepartureTime)(Serializer.Deserialize(s)));
        }
        #endregion
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true, Namespace="http://tempuri.org/WebsitesTemplate.xsd")]
    public partial class WebsiteTemplateAdditionalInfoArrivalTime : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public static async Task<WebsiteTemplateAdditionalInfoArrivalTime> LoadFromFile(string fileName, Windows.Storage.StorageFolder folder)
        {
            var _file = await folder.GetFileAsync(fileName);
            var xml = await Windows.Storage.FileIO.ReadTextAsync(_file);
            return Deserialize(xml);
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(WebsiteTemplateAdditionalInfoArrivalTime));
                }
                return serializer;
            }
        }
        ...
        #region Serialize/Deserialize
        /// <summary>
        /// Serializes current WebsiteTemplateAdditionalInfoArrivalTime object into an XML string
        /// </summary>
        /// <returns>string XML value</returns>
        public virtual string Serialize()
        {
        ...
        /// <summary>
        /// Deserializes workflow markup into an WebsiteTemplateAdditionalInfoArrivalTime object
        /// </summary>
        /// <param name="input">string workflow markup to deserialize</param>
        /// <param name="obj">Output WebsiteTemplateAdditionalInfoArrivalTime object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string input, out WebsiteTemplateAdditionalInfoArrivalTime obj, out System.Exception exception)
        {
            exception = null;
            obj = default(WebsiteTemplateAdditionalInfoArrivalTime);
            try
            {
                obj = Deserialize(input);
                return true;
        ...
        public static bool Deserialize(string input, out WebsiteTemplateAdditionalInfoArrivalTime obj)
        {
            System.Exception exception = null;
            return Deserialize(input, out obj, out exception);
        }
        
        public new static WebsiteTemplateAdditionalInfoArrivalTime Deserialize(string input)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(input);
                return ((WebsiteTemplateAdditionalInfoArrivalTime)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
                if ((stringReader != null))
        ...
        public static WebsiteTemplateAdditionalInfoArrivalTime Deserialize(System.IO.Stream s)
        {
            return ((WebsiteTemplateAdditionalInfoArrivalTime)(Serializer.Deserialize(s)));
        }
        #endregion
    }
